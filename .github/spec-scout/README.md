...
- [ ] `summary-template.md` copied to `.github/spec-scout/`
- [ ] `CONSTITUTION.md` copied to `.github/spec-scout/`
- [ ] `code-to-spec.md` copied to `.github/spec-scout/`
- [ ] `update-context.md` copied to `.github/spec-scout/`
- [ ] `session-tmp-file-protocol.md` copied to `.github/spec-scout/`
